...
Примеры:
    ...
    # Запустить только определенные тесты
    python run_tests_with_report.py pytests/test_get.py
    ...
    python run_tests_with_report.py pytests/test_get.py::test_get_tasks
